...
<html>
  <head>
	...
	<script type="text/javascript">
		function Check()
		{
			...
			var compere=document.getElementById("compere");
			var person=document.getElementById("person");
			var subject=document.getElementById("subject");
			var content=document.getElementById("content");
			if(time.value == null || address.value == null || compere.value == null 
				|| person.value == null ||subject.value == null ||content.value == null)
			{
				alert("请填写完整！");
				return false;
			}
  ...
  <body>
  <form onsubmit="return Check()" method="post" action="admin/Meeting-add-meeting">
  	当前位置：日常管理 - 会议管理 - 添加会议
    <table align="center" border="5">
    	<caption>添加会议</caption>
    	<tr>
    		<th class="typ1">时间：
    		<td class="typ1"><input id="time" name="time" type="text" class="typ1"/>
    		<th class="typ1">地点：
    		<td class="typ1"><input id="address" name="address" type="text" class="typ1"/>
    	</tr>
    	<tr>
    		<th class="typ1">主持人：
    		<td class="typ1"><input id="compere" name="compere" type="text" class="typ1"/>
    		<th class="typ1">参加人员：
